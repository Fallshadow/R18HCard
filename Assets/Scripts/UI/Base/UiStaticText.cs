...
namespace act.ui
{
    ...
    {
        public static string[] FontNames = new string[] { "HYQiHei", "impact" , "BEYNO", "ArialMT","muyao","zhanku", "SourceHanSerifCN-SemiBold","muyao2","muyao3", "muyao4", "muyao5", "muyao6", "muyao7" };
