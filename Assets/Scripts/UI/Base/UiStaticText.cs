...
namespace act.ui
{
    ...
    {
        public static string[] FontNames = new string[] { "HYQiHei", "impact" , "BEYNO", "ArialMT","muyao","zhanku", "SourceHanSerifCN-SemiBold", "SourceHanSerifCN-SemiBold2", "muyao3", "muyao4", "muyao5", "muyao6", "muyao7" };
